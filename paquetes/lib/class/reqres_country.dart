...
//
//     final paises = paisesFromMap(jsonString);

import 'dart:convert';
// Package me
import 'package:paquetes/class/regional_bloc.dart';
import 'package:paquetes/class/translations.dart';
...
class Paises {
  ...
  factory Paises.fromMap(Map<String, dynamic> json) => Paises(
        ...
        area: json["area"],
        gini: json["gini"]?.toDouble(), // Problema
